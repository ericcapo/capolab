    ...
    return `
        <div class="micromates-wrapper">
            ...
            <div class="game-header">
                ...
                <p style="text-align: justify;"><strong>What is MicroMates<sup>™</sup>?</strong> You collect little creatures called mates, each living in a unique ecosystem (a realm) and powered by one of five sources of energy. </p><br>
                <p style="text-align: justify;"><strong>Game rules</strong> (2–6 players): Shuffle and deal 7 cards each. Youngest goes first. On your turn, ask any player for a mate from a specific realm using one of the five energy types. If they have it, take it and continue your turn; if not, draw one card from the pile. Whenever you collect all five energy sources of the same realm, show it and place it face up. First to get <strong>3 realms</strong> wins!</p><br>
                <p style="text-align: justify;"><strong><a href="https://www.capolab.net/oceanicduel.html" target="_blank" style="color: white !important;">Play Oceanic Duel</a></strong>: (online game, 1 player)</p>
                <br>Energy types:</p> 
