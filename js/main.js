    ...
    return `
        <div class="micromates-wrapper">
            ...
            <div class="game-header">
                ...
                <p style="text-align: justify;"><strong>What is this game about?</strong> MicroMates are little creatures living in ecosystems such as the Baltic Sea and the Black Sea, where they use different sources of energy and food and exhibit different metabolic capacities shown as different card types.</p> <br>
                <p style="text-align: justify;"><strong>How to play</strong> (2–6 players): Shuffle all cards. Deal 7 cards each. Youngest starts. On your turn, ask any player for a card types from a <b>realm</b> you already own. If they have it, take it and continue; if not, draw 1 card from the pile. When you complete a realm (5 card types), show it and place it face up. First to collect <strong>3 realms</strong> wins!</p><br>Card types:</p> 
            ...
            <div class="game-header history-section" style="margin-top: 2rem;">
                <div class="game-text-box" style="padding-top: 0;">
                   <h2 style="color: white; font-size: 1.6rem; font-weight: 600; margin: 0; padding: 0.5rem 2rem 0.5rem 2rem; border-bottom: 2px solid rgba(106,176,214,0.3); text-shadow: 1px 1px 2px rgba(0,0,0,0.3);">The Story Behind MicroMates<sup>™</sup></h2> 
                    <p style="text-align: justify;"> The idea of the MicroMates<sup>™</sup> card game came in 2024 after a seminar by Klaus Jürgens at Umeå University when researchers realised that the incredible diversity of microbial metabolisms could be turned into a fun, educational card game. Each card represents a real microorganism, carefully illustrated and linked to scientific references. <br><br>This card game is developed by Eric Capo and Meifang Zhong from Umeå University (Umeå, Sweden), and the artist Thomas Cerigny from Mikimo studio (Bordeaux, France).</p><br>
